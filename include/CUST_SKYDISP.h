...
/* Debug Msg */
/*#if 0 //defined(FEATURE_AARM_RELEASE_MODE) // JYKWON -- SEOULTEK
#define SKYDISP_MSG(...)
#else
...
// novapex_hsj 20120517 bugs fix
#define F_SKYDISP_BUG_FIX_CTS_FRAME_RATE
#define F_SKYDISP_BUG_FIX_MDP_DOWNSCALING
#define F_SKYDISP_BUG_FIX_ROTATE_TO_PORTRAIT_BLINK
#define F_SKYDISP_BUG_FIX_VT_RESET
#define F_SKYDISP_BUG_FIX_YUV_REVERSE
