...
#endif
#ifdef CONFIG_SW_RESET //pdj666 20120302
...
#ifdef FEATURE_SKY_PWR_ONOFF_REASON_CNT // pz1714 20120313 add
extern void set_pwr_onoff_reaseon(void);
#endif
...
NORET_TYPE void panic(const char * fmt, ...)
{
	...
	int state = 0;
#ifdef CONFIG_PANTECH_ERR_CRASH_LOGGING
	static char dispbuf[1024];//pdj666 20120302 512-> 1024
#endif	
#ifdef CONFIG_PANTECH_ERR_CRASH_LOGGING // pdj666 20120302
        va_start(args, fmt);
	...
	if (panic_timeout > 0) {
		 ...
		 */
#if 0// pdj666 20120302 def CONFIG_PANTECH_ERR_CRASH_LOGGING
		strcpy(dispbuf,"\n\n     [ERROR LOG]\n\n");
		strcat(dispbuf,"\n\n     Rebooting cause of Crash\n\n");
		strcat(dispbuf,"\n\n     Press Power key for reboot\n\n");
		strcat(dispbuf,"\n\n     Wait a minute for saving logs until rebooting \n\n");  
...
#if !defined(FEATURE_SW_RESET_RELEASE_MODE)// pz1714 20120313 chg //#ifdef CONFIG_SW_RESET // pdj666 20120302
