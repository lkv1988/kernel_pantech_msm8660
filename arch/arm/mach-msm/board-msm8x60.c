...
static struct mpu3050_platform_data mpu3050_data = {
    ...
    .compass = {
        ...
        .address = 0x2e,
		//N1037 20120222 porting transformed at YAMAHA driver
		.orientation = { 1, 0, 0,
			0, 1, 0,
			0, 0, 1 
		},
...
#endif
#if !defined(F_PANTECH_CAMERA_S5K6AAFX13) && !defined(F_PANTECH_CAMERA_ICP_HD)
static struct msm_camera_sensor_strobe_flash_data strobe_flash_xenon = {
...
#define MSM_ION_QSECOM_SIZE	0x600000/*(6MB)*///0x300000/*(3MB)*/
...
#ifdef FEATURE_SKY_3_5PHIEARJACK // N1037 20120216 porting 
...
#ifdef FEATURE_SKY_MMC ////N0056 mmc0 timeout error min 3.0V -> 2.85V 
...
#ifdef FEATURE_SKY_NFC_ST21NFCA//CONFIG_ST21NFCA //pdj666 20120306
	RPM_LDO(PM8901_L6,  0, 1, 0, 3300000, 3300000, LDO300HMIN),
#else
...
// PZ2224_yikyu 20120313 declared but not used
...
static void __init msm8x60_init(struct msm_board_data *board_data)
{
	...
	if (machine_is_msm8x60_ffa() || machine_is_msm8x60_fusn_ffa() ||
		machine_is_msm8x60_dragon() || machine_is_msm8x60_surf()) {
