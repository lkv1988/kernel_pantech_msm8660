...
static DEFINE_SPINLOCK(pause_on_errlog_lock); //pdj666 20120302
...
// paiksun...
#if 0//pdj666 20120302 def CONFIG_SW_RESET
        while(!pm8xxx_get_pwrkey_status())
        {
                writel(1, WDT0_RST);
                mdelay(1000);
...
#if 1//pdj666 20120302 defined(CONFIG_PANTECH_ERR_CRASH_LOGGING) && !defined(FEATURE_SW_RESET_RELEASE_MODE)
