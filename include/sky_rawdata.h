...
#define GOTA_UPDATE_START		(PANTECH_ROOTING_CHECK_START+PANTECH_ROOTING_CHECK_LENGTH)
#define GOTA_UPDATE_LENGTH		(SECTOR_SIZE*SECTOR_SIZE_DEFAULT)


#define BACKUP_SECTOR_LENGTH            (GOTA_UPDATE_START+GOTA_UPDATE_LENGTH-BACKUP_SECTOR_START)
